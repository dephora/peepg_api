defmodule PeepgApi.User do
  ...
  def changeset(struct, params \\ %{}) do
    ...
    |> validate_required([:email, :name_first, :name_last, :phone_main, :phone_main_ext, :status, :roles_mask, :comments, :password_hash, :reset_password_token, :reset_password_sent_at, :sign_in_count, :current_sign_in_at, :last_sign_in_at, :current_sign_in_ip, :last_sign_in_ip, :remember_inserted_at, :department_id])
